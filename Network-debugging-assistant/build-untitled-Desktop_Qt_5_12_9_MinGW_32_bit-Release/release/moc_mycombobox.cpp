...
#include "../../Project_Serial_Port/untitled/mycombobox.h"
...
QT_MOC_LITERAL(1, 11, 7), // "reflesh"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "myCombobox\0reflesh\0"
};
...
void myCombobox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myCombobox::reflesh)) {
                *result = 0;
                return;
            }
        }
